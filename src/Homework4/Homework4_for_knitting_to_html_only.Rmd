...
The predictive power of all these models is pretty low, as expected. Model MLR:1 is the only model that beats predicting using the mean, and it doesn't beat it by much. We select it as the final multiple linear regression model we will use to make predictions on the evaluation data.
