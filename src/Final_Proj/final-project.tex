...
\begin{verbatim}
## AIC for base model (rating results): -327.068181870516
\end{verbatim}

\begin{verbatim}
## AIC for proxy variable model: -502.587529886915
\end{verbatim}

\begin{verbatim}
## AIC for WLS model: -508.994310071707
\end{verbatim}

\begin{verbatim}
## BIC for base model (rating results): -307.237448174897
\end{verbatim}

\begin{verbatim}
## BIC for proxy variable model: -482.756796191296
\end{verbatim}

\begin{verbatim}
## BIC for WLS model: -489.163576376089
\end{verbatim}
