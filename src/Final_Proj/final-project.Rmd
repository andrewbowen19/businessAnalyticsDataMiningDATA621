...
```{r}
english_formula <- val_mean_score_act_engl_all ~ survey_pp_RI + survey_pp_CT + survey_pp_RI + survey_pp_ES + survey_pp_SE + survey_pp_SF + survey_pp_TR

math_formula <-  val_mean_score_act_math_all ~ survey_pp_RI + survey_pp_CT + survey_pp_RI + survey_pp_ES + survey_pp_SE + survey_pp_SF + survey_pp_TR

# Create lineaer model to predict english and math scores based on sruvey ratings
lm_english <- lm(english_formula, data=df)
lm_math <- lm(math_formula, data=df)
```
