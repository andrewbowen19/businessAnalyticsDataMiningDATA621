...
First, let's plot the counts of different rating combinations by school. This should give us a sense if schools with one rating for a given bucket tend to have similar ratings for other categories (e.g., schools with high *Quality Review Rating* values tend to have high *Achievement Ratings* as well).
```{r}
