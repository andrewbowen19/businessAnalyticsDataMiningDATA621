...
It's interesting to not that with selected variables (walks and hits gained/allowed per team) that our adjusted $R^2$ actually went *down*, indicating the amount of variability in `TARGET_WINS` explained by our more selectvie walks/hits model is *less* than the model including all variables.


```{r plot-hits-wins, echo=FALSE, message=FALSE}
# Plotting total wins  versus a teams hits
