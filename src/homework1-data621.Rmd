...
Overall, we saw comparable RMSE values between our models, indicating similar performance. In a business context, we'd likely select our base model, as it shows the lowest RMSE:
...
The simple model including all variables would be the easiest to explain to non-technical business stakeholders, who may not need to know the ins and outs of our regression model, and are primarily concerned with outcomes.
